  ...
  return (
    <div className="bg-transparent min-h-[calc(100vh-4rem)] text-slate-900 dark:text-slate-100 transition-colors duration-500">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-24 pb-12 sm:pb-20 text-center relative z-10">
      ...
      {/* Features Section */}
      <div id="features" className="py-12 sm:py-24 bg-transparent">
...
const FeatureCard = ({ icon, title, description }) => (
  <div className="glass-panel p-5 sm:p-8 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 group">
    <div className="w-12 h-12 sm:w-14 sm:h-14 bg-primary-500/10 dark:bg-primary-500/20 rounded-xl flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-primary-500/20 dark:group-hover:bg-primary-500/30 transition-colors duration-300">
      {icon}
    </div>
